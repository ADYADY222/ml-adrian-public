      ...
      <form method="post" action="procesare.php" enctype="multipart/form-data">
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="text" id="nombre_lugar" name="nombre_lugar" maxlength="20" oninput="checkLimit()" required>
            <span id="error-message-3" style="color: red;"></span>
          </div>
          <div class="input-box">
            <span class="details">Descripcion:</span>
            <textarea class="test2 textarea" id="descripcion_lugar" name="descripcion_lugar" rows="5" cols="120" required maxlength="100" oninput="checkLimit()"></textarea>
            <span id="error-message-2" style="color: red;"></span>
          </div>
          <div class="input-box">
            <span class="details">Municipio donde se encuentra: </span>
            <select class="test4" name="municipio" required>
